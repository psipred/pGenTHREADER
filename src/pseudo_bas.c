/****************************************************************************
 *
 * pGenTHREADER version 8.2 (Jul 2009)
...
int             main(int argc, char **argv)
{
	...
	for (i = 0; i < nn; i++)
	{
	    fprintf(ofp, "%7.1f %5.2f %5.2f %7.1f %5.2f %5.2f %7.1f %5.2f %7.1f %5.2f %6.1f %4d %4d %4d %s\n",
